    ...
    start-0 border-b border-gray-300 px-6">
      ...
      items-center justify-between mx-auto py-4 ">
        ...
        <div className="flex gap-4">
          ...
          >
            <img src="/img/ico-dentalnet.svg" className="h-12" alt="logo-vortex" />
          </LinkScroll>
        ...
        <div className="flex lg:order-2 space-x-3 lg:space-x-0 rtl:space-x-reversek">
          <div className="hidden lg:flex items-center gap-6">
            <Link to={LOGIN} className="text-white bg-primaryBlue rounded-lg px-5 py-3 text-center font-medium text-sm">
              Iniciar sesión
            </Link>
          </div>
        ...
        >
          <ul className="flex lg:hidden flex-col text-sm font-medium text-negro lg:p-0 lg:flex-row ">
            ...
            {/* Linkeo hacia la parte de modulos */}
            <li>
              <LinkScroll
                to="modulos"
                smooth={true}
