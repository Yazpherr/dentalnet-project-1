      ...
      >
        <div>
          <div className="px-6 my-[120px]">
            {/* Titulo de pagina */}
            <div className="mb-12">
              <p className="text-primaryBlue font-semibold text-center  uppercase mb-4">
                Inicio de sesión
              </p>
              ...
              <p className="text-plomo text-base md:text-lg mt-5 max-w-[800px] mx-auto text-center">
                Ingresa tus datos para acceder a nuestra plataforma
              </p>
            </div>
            {/* Form */}
            <Form
            ...
            <div className="mx-auto max-w-[500px] rounded-xl">
              <div>
                <Link to={REGISTER} className="text-negro text-sm inline-block">
                  ¿No tienes cuenta?{" "}
                  <span className="text-primaryBlue">Créala aquí</span>
                </Link>
              </div>
              <div>
                <Link
                ...
                >
                  ...
                  <span className="text-primaryBlue">Recupérala aquí</span>
                </Link>
              </div>
              ...
              {/*               <div className="mt-4">
                <Link
                  to={LOGININFLUENCERS}
                  className="text-primary bg-white border-2 border-primary
                    rounded-xl flex justify-center items-center  h-[42px] text-sm px-[14px] text-center"
                >
                  Ingreso influencers
                </Link>
              </div> */}
