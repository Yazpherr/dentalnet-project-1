          ...
          <div className="px-6 my-[120px]">
            <div className="mb-12">
              ...
              <p className="text-plomo text-base md:text-lg mt-5 max-w-[500px] mx-auto text-center">
                Comienza a explorar cómo nuestras soluciones pueden transformar
                tu negocio.
              </p>
            </div>
            <Form
            ...
            >
              ...
              {/*               <Form.Item
                ...
                tooltip="El código de registro es un código proporcionado por una institución afiliada a nuestra empresa."
                rules={[
                  { required: true, message: "Ingresa tu código de registro" },
                  {
                    validator: (_, value) =>
                      value && !/^\s+$/.test(value)
                        ? Promise.resolve()
                        : Promise.reject(
                            new Error(
                              "El código de registro no puede contener solo espacios en blanco"
                            )
                          ),
                  },
                ]}
              >
                <Input placeholder="Ingresa tu código de registro" />
              </Form.Item> */}
              ...
              <Form.Item className="mt-6">
                <Button
                  ...
                  className="w-full h-[49px] bg-primaryBlue text-white border-none"
                  htmlType="submit"
                >
                  Registrarme
                </Button>
            ...
            <div className="mx-auto max-w-[500px] rounded-xl">
              <div>
                <Link to={LOGIN} className="text-negro text-sm inline-block">
                  ¿Ya tienes cuenta?{" "}
                  <span className="text-primaryBlue">Inicia sesión aquí</span>
                </Link>
              </div>
              <div>
                <Link
                ...
                >
                  ...
                  <span className="text-primary">Recuperala aquí</span>
                </Link>
              </div>
            </div>
          </div>
